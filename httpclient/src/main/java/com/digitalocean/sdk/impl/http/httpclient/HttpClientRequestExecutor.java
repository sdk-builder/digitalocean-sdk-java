 ...
 */
package com.digitalocean.sdk.impl.http.httpclient;
...
import com.digitalocean.sdk.impl.http.RestException;
import com.digitalocean.sdk.impl.http.authc.DefaultRequestAuthenticatorFactory;
import com.digitalocean.sdk.impl.http.authc.RequestAuthenticator;
import com.digitalocean.sdk.impl.http.support.BackoffStrategy;
import com.digitalocean.sdk.impl.http.support.DefaultRequest;
import com.digitalocean.sdk.impl.http.support.DefaultResponse;
...
public class HttpClientRequestExecutor implements RequestExecutor {
    ...
    private static final String MAX_CONNECTIONS_PER_ROUTE_PROPERTY_KEY = "HttpClientRequestExecutor.connPoolControl.maxPerRoute";
    ...
    private static final String MAX_CONNECTIONS_TOTAL_PROPERTY_KEY = "HttpClientRequestExecutor.connPoolControl.maxTotal";
