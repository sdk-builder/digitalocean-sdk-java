...
public class DefaultResourceFactory implements ResourceFactory {
    ...
    private static final String BASE_PACKAGE = "com.digitalocean.sdk.";
    ...
    static <T extends Resource> Class<T> convertToInterfaceClass(Class<T> clazz) {
        ...
        //e.g. if impl is com.digitalocean.sdk.impl.droplet.DefaultDroplet, 'afterBase' is impl.droplet.DefaultDroplet
        ...
        //now afterBase is droplet.DefaultDroplet
    ...
    static <T extends Resource> Class<T> convertToImplClass(Class<T> clazz) {
        ...
        String afterBase = fqcn.substring(BASE_PACKAGE.length());
        //e.g. if interface is com.digitalocean.sdk.droplet.Droplet, 'afterBase' is droplet.Droplet
