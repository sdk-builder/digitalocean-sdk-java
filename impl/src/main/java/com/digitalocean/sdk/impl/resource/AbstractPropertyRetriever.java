...
import com.digitalocean.sdk.resource.PropertyRetriever;
...
public abstract class AbstractPropertyRetriever implements PropertyRetriever {
    ...
    protected long getLong(LongProperty property) {
        Long value = getLongProperty(property.getName());
        return (value == null) ? -1 : value;
    }

    protected Long getLongProperty(LongProperty property) {
    ...
    private long parseLong(String value) {
        try {
            ...
            if (log.isErrorEnabled()) {
                String msg = "Unable to parse string '{}' into a long value. Defaulting to -1";
                log.error(msg, e);
            }
        }
        return -1;
