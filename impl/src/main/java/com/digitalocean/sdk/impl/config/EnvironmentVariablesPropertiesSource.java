 ...
 */
package com.digitalocean.sdk.impl.config;
...
public class EnvironmentVariablesPropertiesSource implements PropertiesSource {
    ...
    public static PropertiesSource digitaloceanFilteredPropertiesSource() {
        return new DigitalOceanFilteredEnvironmentPropertiesSource();
    }

    private static class DigitalOceanFilteredEnvironmentPropertiesSource extends FilteredPropertiesSource {

        private static final EnvVarNameConverter envVarNameConverter = new DefaultEnvVarNameConverter();

        private DigitalOceanFilteredEnvironmentPropertiesSource() {
            super(new EnvironmentVariablesPropertiesSource(),
                    (key, value) -> {
                        if (key.startsWith("DIGITAL_OCEAN_")) {
