...
public class DefaultEnvVarNameConverter implements EnvVarNameConverter {
    ...
    public String toDottedPropertyName(String envVarName) {
        ...
        if ("DIGITAL_OCEAN_CLIENT_TOKEN".equals(envVarName)) {
            return "digitalocean.client.token";
        }
        if ("DIGITAL_OCEAN_CLIENT_AUTHENTICATIONSCHEME".equals(envVarName)) {
            return "digitalocean.client.authenticationScheme";
        }
        if ("DIGITAL_OCEAN_CLIENT_ORGURL".equals(envVarName)) {
            return "digitalocean.client.orgUrl";
        }
