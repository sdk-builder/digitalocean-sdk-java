...
import com.digitalocean.sdk.impl.util.LinkedCaseInsensitiveMap;
import com.digitalocean.sdk.impl.util.MultiValueMap;
...
public class HttpHeaders implements MultiValueMap<String, String> {
    ...
    public Map<String, String> getLinkMap() {
        ...
        if (!com.digitalocean.sdk.lang.Collections.isEmpty(links)) {
