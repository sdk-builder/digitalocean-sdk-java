...
public class DiscriminatorConfig {
    ...
    /**
     * Loads DiscriminatorConfig from the classpath file: {code}/com/digitlaocean/sdk/resource/discrimination.yaml{code}.
    ...
    static DiscriminatorConfig loadConfig() {
        Yaml yaml = new Yaml();
        String configFile = "/com/digitalocean/sdk/resource/discrimination.yaml";
