 ...
 */
package com.digitalocean.sdk.lang;
...
public class Classes {
    ...
    public static <T> Class<T> forName(String fqcn) throws UnknownClassException {
        ...
        if (clazz == null) {
            ...
            if (fqcn != null && fqcn.startsWith("com.digitalocean.sdk.impl")) {
                msg += "  Have you remembered to include the digitalocean-sdk-impl .jar in your runtime classpath?";
            }
    ...
    public static <T> T newInstance(Class<T> clazz) {
        ...
        try {
            ...
            throw new com.digitalocean.sdk.lang.InstantiationException("Unable to instantiate class [" + clazz.getName() + "]", e);
        }
    }
    ...
    public static <T> T instantiate(Constructor<T> ctor, Object... args) {
        try {
            ...
            throw new com.digitalocean.sdk.lang.InstantiationException(msg, e);
        }
    }
