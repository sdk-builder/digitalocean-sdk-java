 ...
 *
 * <ol>
 *     <li>The environment variable {@code DIGITALOCEAN_CLIENT_TOKEN}.  If either of
 *         these values are present, they override any previously discovered value.</li>
 *     <li>A yaml file that exists at the file path or URL specified by the {@code digitalocean.client.file}
 *         system property.  If this file exists and any values are present, the values override any
 *         previously discovered value.  The {@code digitalocean.client.file} system property String can be an
 *         absolute file path, or it can be a URL or a classpath value by using the {@code url:} or
 *         {@code classpath:} prefixes respectively. Default value is {code ~/.digitalocean/digitalocean.yaml}. </li>
 *     <li>The system properties {@code digitalocean.client.token}.  If this value is present, it will override any
 *     previously discovered values.</li>
 * </ol>
 *
 * <p><b>SECURITY NOTICE:</b> While the {@code digitalocean.client.token} system property may be used to represent your
 ...
 *
 * <pre>
 * import static Caches.*;
 *
 * ...
 *
 * {@link Caches Caches}.{@link Caches#newCacheManager() newCacheManager()}
 ...
 * </pre>
 *
 * <p>See the {@link Caches Caches} utility class and the
 * {@link CacheManagerBuilder CacheManagerBuilder} docs for more information.</p>
 *
 ...
 *
 * <pre>
 * import com.digitalocean.sdk.hazelcast.HazelcastCacheManager;
 * // ... etc ...
 *
...
public interface ClientBuilder {
    ...
    String DEFAULT_CLIENT_API_TOKEN_PROPERTY_NAME = "digitalocean.client.token";
    String DEFAULT_CLIENT_CACHE_ENABLED_PROPERTY_NAME = "digitalocean.client.cache.enabled";
    String DEFAULT_CLIENT_CACHE_TTL_PROPERTY_NAME = "digitalocean.client.cache.defaultTtl";
    String DEFAULT_CLIENT_CACHE_TTI_PROPERTY_NAME = "digitalocean.client.cache.defaultTti";
    String DEFAULT_CLIENT_CACHE_CACHES_PROPERTY_NAME = "digitalocean.client.cache.caches";
    String DEFAULT_CLIENT_ORG_URL_PROPERTY_NAME = "digitalocean.client.orgUrl";
    String DEFAULT_CLIENT_CONNECTION_TIMEOUT_PROPERTY_NAME = "digitalocean.client.connectionTimeout";
    String DEFAULT_CLIENT_AUTHENTICATION_SCHEME_PROPERTY_NAME = "digitalocean.client.authenticationScheme";
    String DEFAULT_CLIENT_PROXY_PORT_PROPERTY_NAME = "digitalocean.client.proxy.port";
    String DEFAULT_CLIENT_PROXY_HOST_PROPERTY_NAME = "digitalocean.client.proxy.host";
    String DEFAULT_CLIENT_PROXY_USERNAME_PROPERTY_NAME = "digitalocean.client.proxy.username";
    String DEFAULT_CLIENT_PROXY_PASSWORD_PROPERTY_NAME = "digitalocean.client.proxy.password";
     ...
     *
     * Currently you should use a com.digitalocean.sdk.impl.api.TokenClientCredentials (if you are NOT using an digitalocean.yaml file)
     *
     ...
     * {@link CacheManagerBuilder CacheManagerBuilder} should be sufficient for your needs. You
     * create a {@code CacheManagerBuilder} by using the {@link Caches Caches} utility class,
     * for example:</p>
     *
     * <pre>
     * import static Caches.*;
     ...
     *     .setCacheManager(
     *         {@link Caches#newCacheManager() newCacheManager()}
     ...
     * {@link CacheManagerBuilder CacheManagerBuilder} might not be sufficient for a
     * multi-instance application that runs on multiple JVMs and/or hosts/servers, as there could be cache-coherency
     * problems across the JVMs.  See the {@link CacheManagerBuilder CacheManagerBuilder}
     ...
     * Bearer Authentication Scheme used to authenticate every request sent to the Digital Ocean API server.
     *
     ...
     * {@code https://api.digitalocean.com/v2} - the most common use case for Okta's public SaaS cloud.
     **
